...
@section('body_content')
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="{{ asset('assets/img/portfolio/wo-residence-01.jpg') }}" alt="" data-aos="fade-in">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 mt-4 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
              ...
              <img src="{{ asset('assets/img/portfolio/wo-residence-07.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
              <!-- <h5 class="text-center">Rumah BSD Anggrek Loka</h5> -->
            
          </div>
        </div>
        <div class="row gy-4 mt-2 mb-5">
          <h1 data-aos="fade-up" data-aos-delay="100" style="color: #eee; margin-top:50px;"><center>WO Residence</center></h1>
          ...
          <div class="col-lg-6 desc-project" style="text-align: left;" data-aos="fade-up" data-aos-delay="100">
            <table width="100%" class="table">
              ...
              <tr>
                ...
                <td style="background: #000; color:#aaa; font-size: 20px;">200 m<sup>2</sup></td>
              </tr>
              <tr>
                <td style="background: #000; color:#f5f5f5; font-size: 20px; font-weight: bold;">Project Year</td>
                <td style="background: #000; color:#aaa; font-size: 20px;">2020z</td>
              </tr>
            </table>
          </div>
          <div class="col-lg-3 desc-project" style="text-align: left;" data-aos="fade-up" data-aos-delay="100"></div>
        ...
        <div class="row gy-4 mt-5 mb-5">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <img src="{{ asset('assets/img/portfolio/wo-residence-02a.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
              <!-- <h5 class="text-center">Kakolait To Go</h5> -->
            
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            
              <img src="{{ asset('assets/img/portfolio/wo-residence-02b.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
        ...
        <div class="row gy-4 mt-5 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
              <img src="{{ asset('assets/img/portfolio/wo-residence-04.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
        ...
        <div class="row gy-4 mt-5 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="110">
              <img src="{{ asset('assets/img/portfolio/wo-residence-05.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
        ...
        <div class="row gy-4 mt-5 mb-5">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <img src="{{ asset('assets/img/portfolio/wo-residence-03a.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
              <!-- <h5 class="text-center">Kakolait To Go</h5> -->
            
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            
              <img src="{{ asset('assets/img/portfolio/wo-residence-03b.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
              <!-- <h5 class="text-center">Kims Residence</h5> -->
        ...
        <div class="row gy-4 mt-5 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="110">
              <img src="{{ asset('assets/img/portfolio/wo-residence-06.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
        ...
        <div class="row gy-4 mt-5 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="110">
              <img src="{{ asset('assets/img/portfolio/wo-residence-08.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
        ...
        <div class="row gy-4 mt-5 mb-5">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="110">
              <img src="{{ asset('assets/img/portfolio/wo-residence-09.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
        <div class="row gy-4 mt-5 mb-5">
          
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="110">
              <img src="{{ asset('assets/img/portfolio/wo-residence-10.jpg') }}" class="img-fluid rounded-1 mb-2 w-100" alt="">
          </div>
        </div>
      </div>
