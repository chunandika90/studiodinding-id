...
<form class="form-horizontal" method="post" action="t_po-simpan4.php">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      <h3 id="myModalLabel"><?php echo $nomor ; ?></h3>
    </div>
    ...
    <div class="modal-footer">
    	<input type="submit" class="btn btn-primary" id="bt_saveu" value="Batal PO" />
