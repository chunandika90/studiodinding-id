...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Confirm Inv.</title>
        ...
        <table id="table1" class="controller table table-bordered table-striped table-hover table-condensed">
        	<thead>
                <tr data-level="header" class="header">
                    <th width="20%"><div align="center">Report Terima Inv.Transfer</div></th>
    ...
    <script type="text/javascript">
		...
		function oc_report(vparam)
		{
			...
			window.open("report-in.php?tg1="+base64_encode(tgl1)+"&tg2="+base64_encode(tgl2)+"&cb="+base64_encode(data)+'&gr='+base64_encode(kdgroup)+'&kt='+base64_encode(kdkatg)+'&it='+base64_encode(kditem)+'&prm='+base64_encode(vparam)+'&kdst='+base64_encode(kdstock),'_self');
		}
		...
		function oc_detail(vparam,tgl1,tgl2,lokasi,kdcabang,kdgroup,kdkatg,kditem,kdstock)
		{
			...
			$.get('report-in2.php',data,fungsi);
		}
		...
		{	
			window.open('report-inp.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&kdst='+kdstock,'_blank');
		}
		
		function exel1b (tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem,kdstock)
		{	
			window.open('report-inx.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&kdst='+kdstock,'_blank');
		}
		
		function cetak1c (tgl1,tgl2,lokasi,kdcab,kdgroup,kdkatg,kditem,kdstock)
		{	
			window.open('report-in2p.php?tg1='+tgl1+'&tg2='+tgl2+'&lok='+lokasi+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&kdst='+kdstock,'_blank');
		}
		
		function exel1c (tgl1,tgl2,lokasi,kdcab,kdgroup,kdkatg,kditem,kdstock)
		{	
			window.open('report-in2x.php?tg1='+tgl1+'&tg2='+tgl2+'&lok='+lokasi+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&kdst='+kdstock,'_blank');
		}
