<?php
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl,b.m_nama as namasupplier,a.m_status 
			from t_ttb_stone a , mssupplier b 
...
<table class="table table-bordered table-condensed">
    <tbody>
        ...
        <tr>
            <td>Lokasi Stock</td>
            <td colspan="3"><?php echo $row['m_cabang']; ?></td>
        </tr>
        <tr>
            <td>Rate Beli</td>
            <td colspan="3"><?php echo $row['m_rate']; ?></td>
        </tr>
        <tr>
            <td>Keterangan</td>
           ...
           // echo $tsql3;
            ...
            while( $row3 = sqlsrv_fetch_array( $stmt3, SQLSRV_FETCH_ASSOC))
            {
                ...
                <tr>
                    ...
                    <td><?php echo number_format($row3['m_jumlah'], 2, '.', ','); ?></td>
                    <td><?php echo number_format($row3['m_total'], 2, '.', ','); ?></td>
                </tr>
                <?php
            }
        ?>
