...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
	<form class="form-horizontal" method="post" action="pb_out-simpan.php"  onsubmit="return validasi()">
    	<div class="container pull-left row-fluid" style="width: 100%; padding: 0 10px;">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4><?php echo 'Pengeluaran PB('.$lokasi.' )' ; ?></h4></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <script type="text/javascript">
		...
		function listsupplier()
		{
			...
			$.get('pb_out-ceksupplier.php',data,fungsi);
		...
		function listlokasi()
		{
			...
			$.get('pb_out-ceklokasi.php',data,fungsi);
		...
		function listlokasi2()
		{
			...
			$.get('pb_out-ceklokasi2.php',data,fungsi);
		...
		function listtype(rowke)
		{
			...
			$.get('pb_out-cektype.php',data,fungsi);
		...
		function listbarang(rowke)
		{
			...
			$.get('pb_out-cekbahan.php',data,fungsi);
		...
		function listtukang(rowke)
		{
			...
			$.get('pb_out-cektukang.php',data,fungsi);
