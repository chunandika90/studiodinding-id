<?php
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl, b.m_nama as namasupplier,  c.m_rubberid,a.m_status , a.m_type, a.m_status_order
			 from t_spk a, msdesigner b , t_spk2 c
			 where 	a.m_designer = b.m_kode and a.m_nomor= c.m_nomor and year(a.m_tanggal) = ".$dumb[0]." and month(a.m_tanggal) = ".$dumb[1] ;
...
<table class="table table-bordered table-striped table-hover table-condensed">
    <thead>
        <tr>
            <th colspan="5"><h4>List SPK</h4></th>
        </tr>
        <tr>
            <th width="100">Nomor</th>
            <th width="100">Rubber ID</th>
            <th width="100">Tanggal</th>
            <th width="150">Designer</th>
            <th width="150">Type</th>
            <th width="150">Status Order</th>
        </tr>
    </thead>
    <tbody>
        <?php
            while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC))
            {
                ...
                <tr <?php if($row['m_status']== 'B'){ ?> style="color:#F00" <?php } ?> >
                    ...
                    <td><?php echo $row['m_status_order']; ?></td>
                </tr>
                <?php
            }
            ?>
