<?php
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl from t_purchase a where year(a.m_tanggal) = ".$dumb[0]." and month(a.m_tanggal) = ".$dumb[1]." and m_type = 'M'" ;
...
<table class="table table-bordered table-striped table-hover table-condensed">
    <thead>
        <tr>
            <th colspan="5"><h4>Inv.Purchase (ADD-EDIT)</h4></th>
        </tr>
        <tr>
            <th width="100">Nomor</th>
            <th width="100">Tanggal</th>
            <th width="150">Nama</th>
            <th width="100">Dokumen ID</th>
        </tr>
    </thead>
    <tbody>
        <?php
