...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Pengeluaran  Rangka</title>
    ...
    <?php
		...
		else
		{
			$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl, convert(varchar(8),m_tanggal,108) as co_jam, 
					 ...
					 left join mslokasi d on a.m_lokasi2 = d.m_kode, mssupplier b 
					 where a.m_lokasi = '".$kdcab."' and a.m_nomor = '".$nomor."' and a.m_supplier = b.m_kode" ;
    ...
    ?>
	<form class="form-horizontal" method="post" action="rangka_out-simpan.php"  onsubmit="return validasi()">
    	<div class="container pull-left row-fluid" style="width: 100%; padding: 0 10px;">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4><?php echo 'Pengeluaran Rangka('.$lokasi.' )' ; ?></h4></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <script type="text/javascript">
		...
		function listsupplier()
		{
			...
			$.get('rangka_out-ceksupplier.php',data,fungsi);
		...
		function listlokasi()
		{
			...
			$.get('rangka_out-ceklokasi.php',data,fungsi);
		...
		function listlokasi2()
		{
			...
			$.get('rangka_out-ceklokasi2.php',data,fungsi);
		...
		function listtype(rowke)
		{
			...
			$.get('rangka_out-cektype.php',data,fungsi);
		...
		function listbarang(rowke)
		{
			...
			$.get('rangka_out-cekbahan.php',data,fungsi);
		...
		function listtukang(rowke)
		{
			...
			$.get('rangka_out-cektukang.php',data,fungsi);
