	...
	<table width="100%" style="border-collapse:collapse;font-family:Arial, Helvetica, sans-serif;font-size:12px">
    	<thead>
        	...
        	<tr height="25" style="border:1px solid #000;background-color:#CCC">            
            	...
            	<th width="80" style="border:1px solid #000">(+/-)%</th>
            	<th width="80" style="border:1px solid #000;color:#F00">ST</th>
            	<th width="80" style="border:1px solid #000;color:#F00">Tanggal</th>
            	<th width="80" style="border:1px solid #000;color:#F00">Nomor</th>
            	<th width="80" style="border:1px solid #000;color:#F00">Harga Asal</th>
        ...
        <tbody>
            ...
            {	
                ...
                <tr height="25">
                    ...
                    <td style="border-right:1px solid #000;color:#F00" align="center"><?php echo $row['m_cabang2']; ?></td>
                    <td style="border-right:1px solid #000;color:#F00" align="center"><?php echo $row['co_tglasal']; ?></td>
                    <td style="border-right:1px solid #000;color:#F00" align="center"><?php echo $row['m_nomor2']; ?></td>
                    <td style="border-right:1px solid #000;color:#F00" align="right"><?php echo number_format($row['m_harga2'], 0, '.', ','); ?></td>
        	...
        	<tr height="25" style="border:1px solid #000;font-weight:bold">
                ...
                <td style="border:1px solid #000" align="right"><?php echo number_format($tdepr, 2, '.', ','); ?></td>
