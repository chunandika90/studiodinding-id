...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%">
    	<tr>
        	...
        	<td width="25%" align="right">
                ...
                {
                    ?>
                    <img src="images/printer.gif" style="cursor:pointer" id="cetakreport1c" onclick="cetak1b('<?php echo $tgl1; ?>','<?php echo $tgl2; ?>','<?php echo $kdcabang; ?>','<?php echo $kdgroup; ?>','<?php echo $kdkatg; ?>','<?php echo $kditem; ?>') "/> 
                    <img src="images/excel.gif" style="cursor:pointer" id="excelreport1c" onclick="exel1b('<?php echo $tgl1; ?>','<?php echo $tgl2; ?>','<?php echo $kdcabang; ?>','<?php echo $kdgroup; ?>','<?php echo $kdkatg; ?>','<?php echo $kditem; ?>') "/>  
                    <?php
                }
                ?>
            </td>
        ...
        <table id="table1" class="controller table table-bordered table-striped table-hover table-condensed">
        	<thead>
                <tr data-level="header" class="header">
                	<th rowspan="2"><h4>Report Omset</h4></th>
                    <th colspan="2"><div align="center">Penjualan</div></th>
                    <th colspan="2"><div align="center">Trade-In</div></th>
                    <th colspan="2"><div align="center">Resell</div></th>
                    <th colspan="2"><div align="center">Resell (di store lain)</div></th>
                    <th colspan="2"><div align="center">Resell (asal store lain)</div></th>
                    <th colspan="2"><div align="center">Net Omset</div></th>
                </tr>
                <tr data-level="header" class="header">
                    <th width="3%"><div align="right">Qty</div></th>
                    <th width="8%"><div align="right">Total</div></th>
                    <th width="3%"><div align="right">Qty</div></th>
                    <th width="8%"><div align="right">Total</div></th>
                    <th width="3%"><div align="right">Qty</div></th>
                    <th width="8%"><div align="right">Total</div></th>
            ...
            <tbody>
			<?php
            $tsql = "select * from dbo.f_reportomset('".$tanggal1."', '".$tanggal2."', '".$kdcabang."', '".$kdgroup."', '".$kdkatg."', '".$kditem."', '".$kdsales."')" ;
            ...
            {	
                $i = $i + 1 ;
				$net = $row['vf_total'] - $row['vf_total2'] - $row['vf_total3'] - $row['vf_total5'] ;
                ...
                <tr <?php echo $tampilanfont; ?> data-level="<?php echo $row['vf_level']; ?>" id="rowke<?php echo $i; ?>" height="25px">
                    ...
                    <td class="data"><div align="right"><?php echo number_format($row['vf_qty2'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_total2'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_qty3'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_total3'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_qty5'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_total5'], 0, '.', ','); ?></div></td>
                    <td class="data" style="color:#F00"><div align="right"><?php echo number_format($row['vf_qty4'], 0, '.', ','); ?></div></td>
                    <td class="data" style="color:#F00"><div align="right"><?php echo number_format($row['vf_total4'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($row['vf_qty'], 0, '.', ','); ?></div></td>
                    <td class="data"><div align="right"><?php echo number_format($net, 0, '.', ','); ?></div></td>
                </tr>
                <?php
            }
            ?>
    ...
    <script type="text/javascript">
		...
		function oc_report(vparam)
		{
			...
			window.open("report-omset.php?tg1="+base64_encode(tgl1)+"&tg2="+base64_encode(tgl2)+"&cb="+base64_encode(data)+'&gr='+base64_encode(kdgroup)+'&kt='+base64_encode(kdkatg)+'&it='+base64_encode(kditem)+'&sl='+base64_encode(kdsales)+'&prm='+base64_encode(vparam),'_self');
		}

		function oc_detail(tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem,kdsales)
		{
			var data={tg1:tgl1,tg2:tgl2,cb:kdcab,gr:kdgroup,kt:kdkatg,it:kditem,sl:kdsales};
			var fungsi=function(respon){
					$("#listplu").html(respon);
				};
			$.get('report-omset2.php',data,fungsi);
		}
