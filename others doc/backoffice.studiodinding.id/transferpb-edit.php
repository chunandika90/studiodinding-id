...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
	<form class="form-horizontal" method="post" action="transferpb-simpan.php"  onsubmit="return validasi()">
                    ...
                    <?php
						...
						if ($nomor != '')
						{
							$tsql3 = "	select 	a.*, d.m_ukuran
										from 	t_transferpb2 a, msstone d
    ...
    <script type="text/javascript">
		...
		function listlokasi()
		{
			...
			$.get('transferpb-ceklokasi.php',data,fungsi);
		...
		function listukang()
		{
			...
			$.get('transferpb-cektukang.php',data,fungsi);
		...
		function listlokasi2()
		{
			...
			$.get('barang_out-ceklokasi2.php',data,fungsi);
