<?php
   ...
   include "mssql-dbnew.php" ;
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl, convert(varchar(10),a.m_canceldate,103) as co_tglbatal from t_retursupp a, mssupplier b where a.m_cabang = '".$kdcabang."' and a.m_nomor = '".$nomor."' and a.m_kodesupp = b.m_kode " ;
	//echo $tsql;
	...
	// Cek total penjualan
	$tsqljual = "select isnull(sum(( m_qty * m_harga ) - m_discount - m_discount2 - m_discount3 - m_discount4),0) as cojual from t_retursupp2 where m_cabang = '".$kdcabang."' and m_nomor = '".$nomor."'";
	...
	// Cek total bayat
	$tsqlbyr = "select isnull(sum(m_jumlah),0) as cobayar from t_retursupp3 where m_cabang = '".$kdcabang."' and m_nomor = '".$nomor."'";
...
?><table class="table table-bordered table-condensed">
    <tbody>
        ...
        <tr>
            <td>Supplier</td>
            <td colspan="3"><?php echo '( '.$row['m_kodesupp'].' ) '.$row['m_nama']; ?></td>
        </tr>
        <tr>
            <td>Keterangan</td>
