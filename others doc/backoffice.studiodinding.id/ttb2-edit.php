...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
	<form class="form-horizontal" method="post" action="ttb2-simpan.php"  onsubmit="return validasi()">
                        ...
                        <td>Konstruksi</td>
                            <td>
                                <select name="m_konstruksi" id="m_konstruksi" class="input-large" >
                                    <?php
                                    $tsqld = "select distinct m_konstruksi from msorangka order by m_konstruksi asc" ;
                                    $stmtd = sqlsrv_query( $con_dbnew, $tsqld);
                                    while( $rowd = sqlsrv_fetch_array( $stmtd, SQLSRV_FETCH_ASSOC))
                                    {
                                        ?>
                ...
                <tbody>
                    <?php
						...
						else
						{
							?>
							<tr>
								<td><input class="input-medium" type="text" id="m_rubberid" name="m_rubberid" value="" style="text-align:left" /> <input type="hidden" id="m_productid" name="m_productid" value="" /></td>
								<td>
						...
						if ($nomor != '')
						{
							...
							{	
								...
								<tr>
									...
									<td><input class="input-small" type="text" id="m_butir<?php echo $b; ?>" name="m_butir<?php echo $b; ?>" value="<?php echo $row3['m_butir']; ?>" style="text-align:right" /></td>
