...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Confirm - LM.Transfer</title>
    ...
    <div class="container" style="width: auto; padding: 0 20px;">
        ...
        <div class="container pull-right" style="width:auto; padding: 0 20px;">
            <span id="detaildata">
            </span>
        </div>
	</div>
    ...
    <script type="text/javascript">
		function oc_transfer(vparam)
		{
			...
			$.get('lmconfirm-list.php',data,fungsi);
		}
		...
		function oc_detail(vparam,kdcab,nomor)
		{
			...
			$.get('lmconfirm-view.php',data,fungsi);
		}
		...
		function confirm_data(vparam,kdcab,nomor)
		{
			var st = $('#kdstore').val() ;
			var pr = $('#periode').val() ;
			if (kdcab == '') { kdcab = st ; }
			window.open("lmconfirm-edit.php?cb="+base64_encode(kdcab)+'&nm='+base64_encode(nomor)+'&st='+base64_encode(st)+'&pr='+base64_encode(pr)+'&prm='+base64_encode(vparam),'_self');
		}
