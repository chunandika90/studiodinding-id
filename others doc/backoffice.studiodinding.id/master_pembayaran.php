...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="container pull-left" style="width: 100%; padding: 0 20px;">
		<div class="span10" style="overflow:auto;overflow-x:hidden;height:800px">
			...
			{
				?>
				<button class="btn" onClick="edit_modal('<?php echo $prm ; ?>','')">Tambah Pembayaran</button>
				<?php
			}
			?></th>
    ...
    <script type="text/javascript">
		...
		function oc_type(vparam)
		{
			...
			window.open('master_pembayaran.php?kd='+base64_encode(vkode)+'&pr='+base64_encode(vperiod)+'&prm='+base64_encode(vparam),'_self');			
		}
		...
		function view_modal(vparam,vkode)
		{
			...
			$.get('master_pembayaran-edit.php',data,fungsi);
		...
		function hapus_modal(vparam,vkode)
		{
			...
			$.get('master_pembayaran-hapus.php',data,fungsi);
		}
