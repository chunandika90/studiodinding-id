<?php
	...
	$tsql = "select a.*, b.m_nama nama_item
			 from master_collection a, master_item b
			 where  a.m_kode = '".$kode."' and a.m_kode_item = b.m_kode " ;
...
<div class="modal-body">
    <form class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input-medium" type="text" id="m_nama_item" value="<?php echo $row['nama_item']; ?>" disabled />
            </div>
        </div>
    </form>				
</div>
