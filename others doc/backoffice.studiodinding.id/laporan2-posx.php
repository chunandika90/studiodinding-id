...
$objPHPExcel->getActiveSheet()->setCellValue('D8', "Disc.Reguler");
$objPHPExcel->getActiveSheet()->setCellValue('E8', "Disc.VIP");
$objPHPExcel->getActiveSheet()->setCellValue('F8', "Disc.Promo");
$objPHPExcel->getActiveSheet()->setCellValue('G8', "Pembulatan");
$objPHPExcel->getActiveSheet()->setCellValue('H8', "Total Disc");
$objPHPExcel->getActiveSheet()->setCellValue('I8', "Disc %");
$objPHPExcel->getActiveSheet()->setCellValue('J8', "Net Sales");
$objPHPExcel->getActiveSheet()->setCellValue('K8', "Net-W");
$objPHPExcel->getActiveSheet()->setCellValue('L8', "Gross-W");
...
while($row=sqlsrv_fetch_array($stmt))
{
	...
	$tcarat = $tcarat + $row['vf_carat'] ;
     ...
     ->setCellValue( "D" . $b, number_format($row['vf_disc1'], 0, '.', ','))
     ->setCellValue( "E" . $b, number_format($row['vf_disc2'], 0, '.', ','))
     ->setCellValue( "F" . $b, number_format($row['vf_disc3'], 0, '.', ','))
     ->setCellValue( "G" . $b, number_format($row['vf_disc4'], 0, '.', ','))
     ->setCellValue( "H" . $b, number_format($totdisc, 0, '.', ','))
     ->setCellValue( "I" . $b, number_format($pctdisc, 2, '.', ','))
     ->setCellValue( "J" . $b, number_format($netsales, 0, '.', ','))
     ->setCellValue( "K" . $b, number_format($row['vf_berat'], 2, '.', ','))
     ->setCellValue( "L" . $b, number_format($row['vf_beratg'], 2, '.', ','))
     ->setCellValue( "M" . $b, number_format($row['vf_butir'], 0, '.', ','))
     ->setCellValue( "N" . $b, number_format($row['vf_carat'], 3, '.', ','));
	 $b++;;
}
	 $objPHPExcel->setActiveSheetIndex(0)
     ->setCellValue( "C" . $b, number_format($tqty1, 0, '.', ','))
     ->setCellValue( "C" . $b, number_format($tdisc1, 0, '.', ','))
     ->setCellValue( "C" . $b, number_format($tdisc2, 0, '.', ','))
     ->setCellValue( "C" . $b, number_format($tdisc3, 0, '.', ','))
     ->setCellValue( "C" . $b, number_format($tdisc4, 0, '.', ','))
     ->setCellValue( "H" . $b, number_format($ttotdisc, 0, '.', ','))
     ->setCellValue( "I" . $b, number_format($tpcdisc, 2, '.', ','))
     ->setCellValue( "J" . $b, number_format($tnetsales, 0, '.', ','))
     ->setCellValue( "K" . $b, number_format($tberat, 2, '.', ','))
     ->setCellValue( "L" . $b, number_format($tberatg, 2, '.', ','))
...
header('Content-Disposition: attachment;filename="laporan_penjualan(rekap).xls"');
