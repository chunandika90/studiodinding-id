...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <table id="table1" class="controller table table-bordered table-striped table-hover table-condensed">
        	<thead>
                <tr data-level="header" class="header">
                    <th width="20%"><div align="center">Report Trade-In</div></th>
    ...
    <script type="text/javascript">
		...
		function oc_report(vparam)
		{
			...
			window.open("report-tradein.php?tg1="+base64_encode(tgl1)+"&tg2="+base64_encode(tgl2)+"&cb="+base64_encode(data)+'&gr='+base64_encode(kdgroup)+'&kt='+base64_encode(kdkatg)+'&it='+base64_encode(kditem)+'&sl='+base64_encode(kdsales)+'&prm='+base64_encode(vparam)+'&by='+base64_encode(reportby),'_self');
		}
		...
		function oc_detail(vparam,tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem,kdsales)
		{
			...
			$.get('report-tradein2.php',data,fungsi);
		}
		...
		{	
			window.open('report-tradeinp.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&sl='+kdsales+'&by='+reportby,'_blank');
		}
		
		function exel1b (tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem,kdsales,reportby)
		{	
			window.open('report-tradeinx.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem+'&sl='+kdsales+'&by='+reportby,'_blank');
		}
		
		function cetak1c (tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem)
		{	
			window.open('report-tradein2p.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem,'_blank');
		}
		
		function exel1c (tgl1,tgl2,kdcab,kdgroup,kdkatg,kditem)
		{	
			window.open('report-tradein2x.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&kt='+kdkatg+'&it='+kditem,'_blank');
		}
