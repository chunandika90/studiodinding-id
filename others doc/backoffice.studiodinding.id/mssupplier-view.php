...
<div class="modal-body">
    <form class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input-xlarge" type="text" id="m_alamat" value="<?php echo $row['m_alamat']; ?>" disabled />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="telepon1">Telepon</label>
            <div class="controls">
            <input class="input-xlarge" type="text" id="m_telepon1" value="<?php echo $row['m_telepon1']; ?>" disabled />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="fax">Fax</label>
            <div class="controls">
            <input class="input-xlarge" type="text" id="m_fax" value="<?php echo $row['m_fax']; ?>" disabled />
            </div>
        </div>
    </form>				
</div>
