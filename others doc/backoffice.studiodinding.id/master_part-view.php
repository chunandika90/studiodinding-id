<?php
	...
	$tsql = "select *
			 from master_part where  m_kode = '".$kode."' " ;
...
<div class="modal-body">
    <form class="form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input-large" type="text" id="m_kode" value="<?php echo $row['m_kode']; ?>" disabled />
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            <label class="control-label" for="tanggal">Nama</label>
            <div class="controls">
            <input class="input-large" type="text" id="m_harga" value="<?php echo $row['m_harga']; ?>" disabled />
            </div>
        </div>
    </form>				
</div>
