<?php
	...
	if ($rubberid == '')
	{
		$tsql = "	select 	a.*, (a.m_harga - a.m_discount - a.m_discount2 - a.m_discount3 - a.m_discount4)  as coharga , 
					b.m_rubberid, b.m_item, b.m_netweight, b.m_grossweight, 
					b.m_totbutir, b.m_totcarat,c.m_nama as co_namabarang
					from 	t_pos2 a, t_stockdata b, msbarang c, t_pos d
					where 	a.m_kodebarang = b.m_kodebarang and 
							a.m_productid = b.m_productid and 
							a.m_nomor = d.m_nomor and
							a.m_cabang = d.m_cabang and
							d.m_kodecust = '".$kdcust."' and
