<?php
	...
	else
	{
		...
		$tsql = "select * from master_part where m_kode = '".$vkode."'   " ;
...
<form class="form-horizontal" method="post" action="master_part-simpan.php">
    ...
    <div class="modal-body">
        <div class="control-group">
            ...
            <input class="input-large" type="text" id="m_kode" name="m_kode" value="<?php echo $vkode; ?>"/>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            <label class="control-label" for="kursbeli">Nama</label>
            <div class="controls">
            <input class="input-large" type="text" id="m_harga" name="m_harga" value="<?php echo $vharga; ?>" required />
            </div>
        </div>
    </div>
