...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php
		...
		else
		{
			...
			from t_ttb_stone a where a.m_cabang = '".$kdcab."' and a.m_nomor = '".$nomor."'" ;
			...
			$tsqllok = "select * from mslokasi where m_kode = '".$lokasi."'" ;
			//echo $tsqlsup;
    ...
    ?>
	<form class="form-horizontal" method="post" action="ttb_stone-simpan.php"  onsubmit="return validasi()">
    	<div class="container pull-left row-fluid" style="width: 80%; padding: 0 10px;">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4><?php echo 'Penerimaan Stone ('.$nomor.' )' ; ?></h4></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Rate</td>
                        <td colspan="3"><input class="input-small" type="text" id="m_rate" name="m_rate" value="<?php echo $rate; ?>" /></td>
                    </tr>
                    </tr>
                </tbody>
            </table>
            ...
            <table id="table_batu" class="table table-bordered table-striped table-hover table-condensed">
						...
						if ($nomor != '')
						{
							...
							{	
								...
								<tr>
									...
									<td><input class="input-small" type="text" id="m_jumlah<?php echo $b; ?>" name="m_jumlah<?php echo $b; ?>" value="<?php echo $row3['m_jumlah']; ?>" style="text-align:right" />
									<td><input class="input-small" type="text" id="m_total<?php echo $b; ?>" name="m_total<?php echo $b; ?>" value="<?php echo $row3['m_total']; ?>" style="text-align:right" />
                                    </td>
									<td>
                ...
                <tfoot>
                	<tr>
                        ...
                        <th><div id="sp-tottotal" align="right"><?php echo number_format($ttotal, 2, '.', ','); ?></div></th>
                        <th></th>
                    </tr>
                    <tr>
                        <th colspan="10">
    ...
    <script type="text/javascript">
		...
		function listlokasi()
		{
			...
			$.get('barang_in-ceklokasi.php',data,fungsi);
...
//			$( "#dialog-listdoc" ).dialog( "open" );
		...
		function recalc2()
		{
			...
			{	
				...
				document.getElementById('m_jumlah' + i).value = formatangka(jumlah.toFixed(2).toString()) ;
			  ...
			  $("#sp-totjumlah").html(formatangka((tjumlah).toFixed(2).toString()));
		...
		function add_data()
		{
		  ...
		  cellno.innerHTML='<td><div align="left"><input class="input-small" type="text" id="m_jumlah'+iteration2+'" name="m_jumlah'+iteration2+'" value="0" style="text-align:right" onChange="recalc2()" /></div></td>';
		  
		  var cellno = row2.insertCell(9);
		  cellno.innerHTML='<td><div align="left"><input class="input-small" type="text" id="m_total'+iteration2+'" name="m_total'+iteration2+'" value="0" style="text-align:right" onChange="recalc2()" readonly/></div></td>';
		  
		  var cellno = row2.insertCell(10);
