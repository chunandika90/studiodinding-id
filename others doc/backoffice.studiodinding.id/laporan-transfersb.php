...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
		...
		function oc_report(vparam)
		{
			...
			$.get('laporan-transfersb1.php',data,fungsi);
		}
		...
		function oc_detail(detby, kd)
		{
			...
			$.get('laporan-transfersb2.php',data,fungsi);
		}
		...
		function f_export()
		{
			...
			window.open('transfersb-export1a.php?tgl1='+tgl1+'&tgl2='+tgl2+'&kdcabang='+kdcabang+'&kdshape='+kdshape+'&kdsize='+kdsize+'&dimensi='+dimensi+'&kdby='+kdby,'_blank');
		}
		...
		{	
			window.open('laporan-transfersbp.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&by='+reportby,'_blank');
		}
		
		function exel1b (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby)
		{
			window.open('laporan-transfersbx.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&by='+reportby,'_blank');
		}
		
		function cetak1c (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby,vkode,vnama)
		{	
			window.open('laporan-transfersb2p.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&pl='+kdplu+'&by='+reportby+'&vkode='+vkode+'&vnama='+vnama);
		}
		
		function exel1c (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby,vkode,vnama)
		{	
			window.open('laporan-transfersb2x.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&pl='+kdplu+'&by='+reportby+'&vkode='+vkode+'&vnama='+vnama);
		}
