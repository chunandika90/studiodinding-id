...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
	<form class="form-horizontal" method="post" action="rangka_in-simpan.php"  onsubmit="return validasi()">
    	<div class="container pull-left row-fluid" style="width: 100%; padding: 0 10px;">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4><?php echo 'Penerimaan Barang('.$lokasi.' )' ; ?></h4></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table id="table_data" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tfoot>           
                    <tr>
                        ...
                        <th><div id="sp-totgross" align="center"><?php echo number_format($tgrossweight, 2, '.', ','); ?></div></th>
                        <th colspan="1"></th>
                    </tr>
                    <tr>
                        <th colspan="8">
    ...
    <script type="text/javascript">
		...
		function listsupplier()
		{
			...
			$.get('rangka_in-ceksupplier.php',data,fungsi);
		...
		function listlokasi()
		{
			...
			$.get('rangka_in-ceklokasi.php',data,fungsi);
		...
		function listlokasi2()
		{
			...
			$.get('rangka_in-ceklokasi2.php',data,fungsi);
		...
		function listtype(rowke)
		{
			...
			$.get('rangka_in-cektype.php',data,fungsi);
		...
		function listbarang(rowke)
		{
			...
			$.get('rangka_in-cekbahan.php',data,fungsi);
		...
		function listbarang2(rowke)
		{
			...
			$.get('rangka_in-cekbahan2.php',data,fungsi);
		...
		function listtukang(rowke)
		{
			...
			$.get('rangka_in-cektukang.php',data,fungsi);
