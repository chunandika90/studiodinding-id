<?php
	...
	else
	{
		...
		$tsql = "select * from master_upholstery_category where m_kode = '".$vkode."'   " ;
...
<form class="form-horizontal" method="post" action="master_upholstery_category-simpan.php">
    ...
    <div class="modal-body">
        ...
        <div class="control-group">
            <label class="control-label" for="kursbeli">Nama</label>
            <div class="controls">
            <input class="input-medium" type="text" id="m_harga" name="m_harga" value="<?php echo $vharga; ?>" required />
            </div>
        </div>
    </div>
