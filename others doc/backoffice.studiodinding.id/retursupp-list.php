<?php
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl from t_retursupp a where year(a.m_tanggal) = ".$dumb[0]." and month(a.m_tanggal) = ".$dumb[1] ;
...
<table class="table table-bordered table-striped table-hover table-condensed">
    <thead>
        <tr>
            <th colspan="5"><h4>Retur Supplier</h4></th>
        </tr>
        <tr>
