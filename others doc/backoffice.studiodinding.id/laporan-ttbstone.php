...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Perimaan Barang</title>
        	...
        	<td width="25%">
                <div class="input-prepend">
                    ...
                    <select name="kdcabang" id="kdcabang" class="input-medium" onChange="oc_cabang()">
                        <?php
                        $tsqlcabang = "select a.m_kode, a.m_nama from mslokasi a where m_kode = 'PUSAT-SK' order by a.m_kode asc" ;
            ...
            <td>
                <div class="input-prepend">
                    ...
                    <select name="reportby" id="reportby" class="input-medium">
                        <option value="01" >Lokasi</option>
                        <option value="02" >Supplier</option>
                        <option value="03" selected>Shape</option>
    ...
    <script type="text/javascript">
		...
		function oc_report(vparam)
		{
			...
			$.get('laporan-ttbstone1.php',data,fungsi);
		}
		...
		function oc_detail(detby, kd)
		{
			...
			$.get('laporan-ttbstone2.php',data,fungsi);
		}
		...
		function f_export()
		{
			...
			window.open('ttb_stone-export1a.php?tgl1='+tgl1+'&tgl2='+tgl2+'&kdcabang='+kdcabang+'&kdshape='+kdshape+'&kdsize='+kdsize+'&dimensi='+dimensi+'&kdby='+kdby,'_blank');
		}
		...
		{	
			window.open('laporan-ttbstonep.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&by='+reportby,'_blank');
		}
		
		function exel1b (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby)
		{
			window.open('laporan-ttbstonex.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&by='+reportby,'_blank');
		}
		
		function cetak1c (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby,vkode,vnama)
		{	
			window.open('laporan-ttbstone2p.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&pl='+kdplu+'&by='+reportby+'&vkode='+vkode+'&vnama='+vnama);
		}
		
		function exel1c (tgl1,tgl2,kdcab,kdgroup,kditem,kdplu,reportby,vkode,vnama)
		{	
			window.open('laporan-ttbstone2x.php?tg1='+tgl1+'&tg2='+tgl2+'&cb='+kdcab+'&gr='+kdgroup+'&it='+kditem+'&pl='+kdplu+'&by='+reportby+'&vkode='+vkode+'&vnama='+vnama);
		}
