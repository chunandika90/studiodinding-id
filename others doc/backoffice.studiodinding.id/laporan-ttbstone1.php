    ...
    <table id="table1" class="controller table table-bordered table-striped table-hover table-condensed">
        <thead>
            <tr data-level="header" class="header">
                <th width="20%"><div align="center">Report Penerimaan, Cabang - <?php echo $kdcabang ; ?></div></th>
                <th width="10%"><div align="right">Carat</div></th>
                <th width="10%"><div align="right">Jumlah</div></th>
        ...
        {	
            ...
            <tr height="25px">
                ...
                <td><div align="right"><?php echo number_format($row['vf_jumlah'], 2, '.', ','); ?></div></td>
                <td><div align="right"><?php echo number_format($row['vf_total'], 2, '.', ','); ?></div></td>
            </tr>
            <?php
        }
        ?>
        ...
        <tr>
            ...
            <th><div align="right"><?php echo number_format($tjumlah, 2, '.', ','); ?></div></th>
            <th><div align="right"><?php echo number_format($ttotal, 2, '.', ','); ?></div></th>
        </tr>
        </tfoot>
    </table>
