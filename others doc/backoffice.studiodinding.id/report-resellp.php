...
tbody
{
	...
	<table style="border-collapse:collapse;font-family:Arial, Helvetica, sans-serif;font-size:12px">
    	<thead>
        	<tr>
            	<th colspan="12" align="left"><h2>LAPORAN Resell (<?php echo $kdcabang;  ?>)</h2></th>
            </tr>
        	<tr>
        	...
        	<tr height="25" style="border:1px solid #000;background-color:#CCC">
            	...
            	<th width="125" style="border:1px solid #000">Buy Back</th>
            	<th width="125" style="border:1px solid #000">Nilai Awal</th>
            	<th width="75" style="border:1px solid #000">% Depr</th>
        ...
        <tbody >
            ...
            {	
                ...
                <tr height="25" <?php echo $tampilanfont; ?> data-level="<?php echo $row['vf_level']; ?>" id="rowke<?php echo $i; ?>">
                   ...
                   <td style="border-left:1px solid #000;border:1px solid #000" align="right"><?php echo number_format($row['vf_asal'], 0, '.', ','); ?></td>
                   <td style="border-left:1px solid #000;border:1px solid #000" align="right"><?php echo number_format($depr, 2, '.', ','); ?></td>
