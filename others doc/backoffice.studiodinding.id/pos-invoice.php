...
<form class="form-horizontal" method="post" action="pos-simpan2.php">
    ...
    <div class="modal-body">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input-medium" type="text" id="m_jumlah" name="m_jumlah" value="<?php echo number_format($sisa, 0, '.', ',') ; ?>" onChange="recalc_payment()" />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="jumlah">Rate</label>
            <div class="controls">
            <input class="input-medium" type="text" id="m_rate" name="m_rate" value="0"   onChange="recalc_payment()"/>
            </div>
        </div>
        
        <div class="control-group">
            <label class="control-label" for="jumlah">Pembulatan</label>
            <div class="controls">
            <input class="input-medium" type="text" id="m_pembulatan" name="m_pembulatan" value="0"   onChange="recalc_payment()"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="jumlah">Total Rp</label>
            <div class="controls">
            <input class="input-medium" type="text" id="m_total" name="m_total" value="0"  onChange="recalc_payment()"/>
            </div>
        </div>
        
        <div class="control-group">
            <label class="control-label" for="jumlah">Nomor Dokumen Retur</label>
            <div class="controls">
            <input class="input-medium" type="text" id="m_nodoc" name="m_nodoc" value=""   />
            </div>
        </div>
    </div>
