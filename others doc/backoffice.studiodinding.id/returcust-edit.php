...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php
		...
		else
		{
			$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl, convert(varchar(8),m_tanggal,108) as co_jam , b.m_alamat, 
					 ...
					 from t_returcust a, mscustomer b where a.m_cabang = '".$kdcab."' and a.m_nomor = '".$nomor."' and a.m_kodecust = b.m_kode" ;
    ...
    ?>
	<form class="form-horizontal" method="post" action="returcust-simpan.php"  onsubmit="return validasi()">
    ...
    <script type="text/javascript">
		...
		{
			window.open("returcust.php?st="+base64_encode(kdstore)+'&pr='+base64_encode(periode)+'&prm='+base64_encode(vparam),'_self');
		}
		...
		{
			var data={kdcab:$('#m_cabang').val(),kdcust:$('#m_kodecust').val(), noplu:$('#m_productid'+rowke).val(), rubberid:$('#m_rubberid'+rowke).val()};
			...
			$.get('returcust-cekplu.php',data,fungsi);
		}
