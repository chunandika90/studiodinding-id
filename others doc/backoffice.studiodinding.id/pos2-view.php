            ...
            while( $row2 = sqlsrv_fetch_array( $stmt2, SQLSRV_FETCH_ASSOC))
            {
                ...
                <tr>
                    ...
                    <td><div align="center">
                        ...
                        {
                            ?>
	                    	<img src="images/printer.gif" width="15" style="cursor:pointer" id="cetak<?php echo $i; ?>" onclick="print_data('<?php echo $kdstore; ?>','<?php echo $nomor; ?>','<?php echo $row2['m_kodebarang']; ?>','<?php echo $row2['m_productid']; ?>')"/>
