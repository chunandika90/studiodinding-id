...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Master Harga Upholstery</title>
    ...
    <?php
		...
		$tsql2 = "	select *
					from master_upholstery_category 
					order by m_kode asc" ;
    ...
    <div class="container pull-left" style="width: 60%; padding: 0 20px;">
		<div class="span10" style="overflow:auto;overflow-x:hidden;height:500px">
			...
			{
				?>
				<button class="btn" onClick="edit_modal('<?php echo $prm ; ?>','')">Tambah Upholstery</button>
				<?php
			}
			?></th>
            <table class="table table-bordered table-striped table-hover table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4>Master Harga Upholstery</h4></th>
                    </tr>
    ...
    <script type="text/javascript">
		...
		function oc_type(vparam)
		{
			...
			window.open('master_upholstery_category.php?kd='+base64_encode(vkode)+'&pr='+base64_encode(vperiod)+'&prm='+base64_encode(vparam),'_self');			
		}
		...
		function view_modal(vparam,vkode)
		{
			...
			$.get('master_upholstery_category-view.php',data,fungsi);
		...
		function edit_modal(vparam,vkode)
		{
			...
			$.get('master_upholstery_category-edit.php',data,fungsi);
		...
		function hapus_modal(vparam,vkode)
		{
			...
			$.get('master_upholstery_category-hapus.php',data,fungsi);
		}
