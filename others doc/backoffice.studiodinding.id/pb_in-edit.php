...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
	<form class="form-horizontal" method="post" action="pb_in-simpan.php"  onsubmit="return validasi()">
    	<div class="container pull-left row-fluid" style="width: 100%; padding: 0 10px;">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4><?php echo 'Penerimaan PB('.$lokasi.' )' ; ?></h4></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <script type="text/javascript">
		...
		function listsupplier()
		{
			...
			$.get('pb_in-ceksupplier.php',data,fungsi);
		...
		function listlokasi()
		{
			...
			$.get('pb_in-ceklokasi.php',data,fungsi);
		...
		function listlokasi2()
		{
			...
			$.get('pb_in-ceklokasi2.php',data,fungsi);
		...
		function listtype(rowke)
		{
			...
			$.get('pb_in-cektype.php',data,fungsi);
		...
		function listbarang(rowke)
		{
			...
			$.get('pb_in-cekbahan.php',data,fungsi);
		...
		function listbarang2(rowke)
		{
			...
			$.get('pb_in-cekbahan2.php',data,fungsi);
		...
		function listtukang(rowke)
		{
			...
			$.get('pb_in-cektukang.php',data,fungsi);
