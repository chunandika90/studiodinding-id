...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php
		...
		$tsql2 = "	select a.*, b.m_nama nama_item, c.m_nama nama_collection
					from master_modular a, master_item b, master_collection c
					where a.m_kode_item = b.m_kode and a.m_kode_collection = c.m_kode
    ...
    <div class="container pull-left" style="width: 60%; padding: 20px 20px;">
		<div class="span10" style="overflow:auto;overflow-x:hidden;height:500px">
			...
			{
				?>
				<button class="btn" onClick="edit_modal('<?php echo $prm ; ?>','')">Tambah Modular</button>
				<?php
			}
			?></th>
            <table class="table table-bordered table-striped table-hover table-condensed">
                <thead>
                    <tr>
                        <th colspan="4"><h4>Master Modular</h4>
                    </tr>
                    ...
                    <?php
                        ...
                        while($row2 = $stmt2->fetch_assoc())
                        {
                            ...
                            <tr>
                                ...
                                <td onClick="view_modal('<?php echo $prm ; ?>','<?php echo $row2['m_kode'] ; ?>')" style="cursor:pointer"><?php echo $row2['nama_collection']; ?></td>
                            </tr>
                            <?php
                        }
                        ?>
    ...
    <script type="text/javascript">
		...
		function oc_type(vparam)
		{
			...
			window.open('master_modular.php?kd='+base64_encode(vkode)+'&pr='+base64_encode(vperiod)+'&prm='+base64_encode(vparam),'_self');			
		}
		...
		function view_modal(vparam,vkode)
		{
			...
			$.get('master_modular-view.php',data,fungsi);
		...
		function edit_modal(vparam,vkode)
		{
			...
			$.get('master_modular-edit.php',data,fungsi);
		...
		function hapus_modal(vparam,vkode)
		{
			...
			$.get('master_modular-hapus.php',data,fungsi);
		}
