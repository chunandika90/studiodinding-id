...
$objPHPExcel->getActiveSheet()->setCellValue('F8', "Sales");
$objPHPExcel->getActiveSheet()->setCellValue('G8', "Product ID");
...
$objPHPExcel->getActiveSheet()->setCellValue('K8', "Harga");
$objPHPExcel->getActiveSheet()->setCellValue('L8', "Tot.Disc");
$objPHPExcel->getActiveSheet()->setCellValue('M8', "Net.Sales");
$objPHPExcel->getActiveSheet()->setCellValue('N8', "Net");
$objPHPExcel->getActiveSheet()->setCellValue('O8', "Butir");
$objPHPExcel->getActiveSheet()->setCellValue('P8', "Carat");
...
$objPHPExcel->setActiveSheetIndex(0)
     ...
     ->setCellValue( "F" . $b, $row['m_kodesales'])
	 ->setCellValue( "G" . $b, $row['m_productid'])
     ->setCellValue( "H" . $b, $row['namabarang'])
     ->setCellValue( "I" . $b, $row['namaitem'])
     ->setCellValue( "J" . $b, $row['m_qty'])
     ->setCellValue( "K" . $b, number_format($row['m_harga'], 0, '.', ','))
     ->setCellValue( "L" . $b, number_format($totdisc, 0, '.', ','))
     ->setCellValue( "M" . $b, number_format($row['m_harga']-$totdisc, 0, '.', ','))
     ->setCellValue( "N" . $b, number_format($row['m_netweight'], 2, '.', ','))
     ->setCellValue( "O" . $b, number_format($row['m_butir'], 0, '.', ','))
     ->setCellValue( "P" . $b, number_format($row['m_carat'], 3, '.', ','));
	 $b++;;
}

$objPHPExcel->setActiveSheetIndex(0)

     ->setCellValue( "J" . $b, number_format($tqty, 0, '.', ','))
     ->setCellValue( "K" . $b, number_format($tharga, 0, '.', ','))
     ->setCellValue( "L" . $b, number_format($tdisc, 0, '.', ','))
     ->setCellValue( "M" . $b, number_format($tnet, 0, '.', ','))
     ->setCellValue( "N" . $b, number_format($tnetw, 2, '.', ','))
     ->setCellValue( "O" . $b, number_format($tbutir, 0, '.', ','))
     ->setCellValue( "P" . $b, number_format($tcarat, 3, '.', ','));
	 $b++;;
