...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <tr>
                    <th colspan="6">
                        ...
                        <div class="pull-right">
                            ...
                            {
                                ?>
                                <button class="btn" onClick="edit_modal('<?php echo $prm ; ?>','')">Tambah Tukang</button>
                                <?php
                            }
                            ?>
                        </div>
            ...
            <tbody>
                <?php
                    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC))
                    {
                        ?>
                        <tr>
                            <td onClick="view_modal('<?php echo $prm ; ?>','<?php echo $row['m_kode']; ?>')" 
                            	style="cursor:pointer"><?php echo $row['m_kode']; ?></td>
    ...
    <script type="text/javascript">
		function view_modal(vparam,pkode)
		{
			...
			$.get('mstukang-view.php',data,fungsi);
		...
		function edit_modal(vparam,pkode)
		{
			...
			$.get('mstukang-edit.php',data,fungsi);
		...
		function hapus_modal(vparam,pkode)
		{
			...
			$.get('mstukang-hapus.php',data,fungsi);
