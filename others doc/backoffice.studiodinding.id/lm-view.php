<?php
   ...
   include "mssql-dbnew.php" ;
	...
	$tsql = "select a.*, convert(varchar(10),a.m_tanggal,103) as co_tgl, convert(varchar(10),a.m_canceldate,103) as co_tglbatal, b.m_alamat, b.m_kota, b.m_telepon1, b.m_telepon2 from t_pos a, mscustomer b where a.m_cabang = '".$kdstore."' and a.m_nomor = '".$nomor."' and a.m_kodecust = b.m_kode " ;
...
<table class="table table-bordered table-striped table-hover table-condensed">
    <thead>
        <tr>
            ...
            <th width="5%">Qty</th>
            <th width="13%">Item</th>
            <th width="12%"><div align="right">Harga/pcs</div></th>
        ...
        <?php
            ...
            while( $row2 = sqlsrv_fetch_array( $stmt2, SQLSRV_FETCH_ASSOC))
            {
                ...
                <tr>
                    ...
                    <td><div align="right"><?php echo number_format(($row2['m_harga']*$row2['m_qty']), 0, '.', ','); ?></div></td>
                </tr>
                <?php
            }
        ?>
...
<table class="table table-bordered table-striped table-hover table-condensed">
    ...
    <tfoot>
        ...
        <tr>
			...
			{
				?>
                      <button class="btn btn-primary" onclick="add_inv('<?php echo $prm; ?>','<?php echo $kdstore; ?>','<?php echo $nomor; ?>','<?php echo $row['m_type']; ?>')">Entry Pembayaran</button>
                <?php
			}
			else
			{
