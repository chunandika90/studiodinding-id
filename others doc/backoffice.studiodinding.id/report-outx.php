...
$objPHPExcel->getActiveSheet()->setCellValue('A1', "Report Pengeluaran");
...
//Add some data
	$tsql = "select * from dbo.f_reportout('".$tanggal1."', '".$tanggal2."', '".$kdcabang."', '".$kdgroup."', '".$kdkatg."', '".$kditem."', '".$kdstock."')" ;
...
header('Content-Disposition: attachment;filename="laporan_pengeluaran(rekap).xls"');
