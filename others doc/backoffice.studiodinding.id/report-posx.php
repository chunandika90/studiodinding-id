...
$objPHPExcel->getActiveSheet()->setCellValue('A1', "Report Penjualan");
...
$objPHPExcel->getActiveSheet()->setCellValue('G8', "Disc.Reguler");
$objPHPExcel->getActiveSheet()->setCellValue('H8', "Disc.VIP");
$objPHPExcel->getActiveSheet()->setCellValue('I8', "Disc.Promo");
$objPHPExcel->getActiveSheet()->setCellValue('J8', "Pembulatan");
$objPHPExcel->getActiveSheet()->setCellValue('K8', "Total Disc");
$objPHPExcel->getActiveSheet()->setCellValue('L8', "% Disc");
$objPHPExcel->getActiveSheet()->setCellValue('M8', "Net Sales");


$objPHPExcel->getActiveSheet()->getStyle('A7:M8')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('G:M')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
$objPHPExcel->getActiveSheet()->getStyle('A1:M8')->getFont()->setName('Calibri');
...
$objPHPExcel->setActiveSheetIndex(0)
     ...
     ->setCellValue( "G" . $b, number_format($row['vf_discount'], 0, '.', ','))
     ->setCellValue( "H" . $b, number_format($row['vf_discount2'], 0, '.', ','))
     ->setCellValue( "I" . $b, number_format($row['vf_discount3'], 0, '.', ','))
     ->setCellValue( "J" . $b, number_format($row['vf_discount4'], 0, '.', ','))
     ->setCellValue( "K" . $b, number_format($totdisc, 0, '.', ','))
     ->setCellValue( "L" . $b, number_format($pctdisc, 2, '.', ','))
     ->setCellValue( "M" . $b, number_format($netsales, 0, '.', ','));
	 $b++;;
}
