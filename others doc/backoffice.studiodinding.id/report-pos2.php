<?php
	...
	if ( $kdsales != 'ALL' ){$tsql = $tsql . " and z.m_kodesales = '".$kdsales."'";}
	
	$tsql = $tsql." order by z.m_cabang asc, z.m_tanggal asc, z.m_nomor asc, a.m_kodebarang asc, b.m_kategori asc, b.m_item asc, b.m_productid asc" ;
