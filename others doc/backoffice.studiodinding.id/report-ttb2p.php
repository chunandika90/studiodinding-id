...
tbody
{
	...
	<table width="100%" style="border-collapse:collapse;font-family:Arial, Helvetica, sans-serif;font-size:12px">
    	<thead>
        	<tr>
            	<th colspan="10" align="left"><h2>Report Receive Inv <?php echo $kdcabang;  ?></h2></th>
            </tr>	   
        ...
        <tbody>
            ...
            {	
                ...
                ?>
                <tr height="25">
                    <td style="border-left:1px solid #000;border-right:1px solid #000" align="center"><?php echo $row['co_tgl']; ?></td>
